python3 ./face_lib/utils/fusion/fusion_debug.py \
...
#  --dataset_path=/gpfs/gpfs0/r.kail/IJB/IJBC_cropped_debug \
#  --dataset_path=/gpfs/gpfs0/r.kail/IJB/IJBC_cropped_good_small \
#  --dataset_path=/gpfs/gpfs0/r.kail/IJB/IJBC_cropped_good_big \