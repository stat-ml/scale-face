...
if __name__ == "__main__":
    ...
    data_dir = (
        "/home/jovyan/jupyer/benchmark_images/faceu/face_recognition/casia_webface"
    )
    ...
    print(
        "num_org : %4d, num_align : %4d, num_inter : %4d"
        % (len(df_org), len(df_align), len(df_inter))
    )
    ...
    df_inter.to_csv(
        os.path.join(data_dir, "anno_file/casia_org_join_align.csv"), index=None
    )
