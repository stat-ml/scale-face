...
## Classifier
#python3 ./face_lib/utils/reject_verification.py \
#  --checkpoint_path=/beegfs/home/r.kail/Faces/face-evaluation/exman/tmp/000044-2021-10-11-20-55-20/checkpoints/sota.pth \
#  --dataset_path=/gpfs/gpfs0/k.fedyanin/space/IJB/aligned_data_for_fusion/big \
...
# Classifier
python3 ./face_lib/utils/reject_verification.py \
  --checkpoint_path=/beegfs/home/r.kail/Faces/face-evaluation/exman/runs/000050-2021-10-12-03-47-21/checkpoints/sota.pth \
  --dataset_path=/gpfs/gpfs0/k.fedyanin/space/IJB/aligned_data_for_fusion/big \
  --pairs_table_path=/gpfs/gpfs0/k.fedyanin/space/IJB/aligned_data_for_fusion/metadata_refuse_verification/pairs_1000000_prob_0.5.csv \
  ...
  --FARs 0.0001 0.0005 0.001 0.005 0.01 0.05 \
  --rejected_portions $(seq 0 0.002 0.2) \
  --distance_uncertainty_metrics classifier_classifier cosine_classifier MLS_classifier classifier_harmonic-sum cosine_harmonic-sum \
  --device_id=0 \
  --save_fig_path=/gpfs/data/gpfs0/r.kail/figures/pair_classifiers/bilinear
#  --save_fig_path=/gpfs/data/gpfs0/r.kail/figures/pair_classsifiers
#  --save_fig_path=/gpfs/data/gpfs0/r.kail/figures/classifiers/classifier_smart_cosine/
#  --checkpoint_path=/beegfs/home/r.kail/Faces/face-evaluation/exman/tmp/000044-2021-10-11-20-55-20/checkpoints/sota.pth \
